...
void add_sphere( struct matrix * polygons,
  ...
  for ( lat = latStart; lat < latStop; lat++ ) {
    for ( longt = longStart; longt < longStop; longt++ ) {
      ...
      //cases 0 and 1: adding triangles on the edge of the sphere
      if (index % step == 0) add_polygon( polygons, points->m[0][index], points->m[1][index], points->m[2][index], points->m[0][index + 1], points->m[1][index + 1], points->m[2][index + 1], points->m[0][(index + step + 1) % (step * (step - 1))], points->m[1][(index + step + 1) % (step * (step - 1))], points->m[2][(index + step + 1) % (step * (step - 1))]);
      else if (index % step == step - 2) add_polygon( polygons, points->m[0][index], points->m[1][index], points->m[2][index], points->m[0][index + 1], points->m[1][index + 1], points->m[2][index + 1], points->m[0][(index + step) % (step * (step - 1))], points->m[1][(index + step) % (step * (step - 1))], points->m[2][(index + step) % (step * (step - 1))]);
      
      //case 2 (most common): adding triangles in the middle of the sphere
      else {
        add_polygon( polygons, points->m[0][index], points->m[1][index], points->m[2][index], points->m[0][index + 1], points->m[1][index + 1], points->m[2][index + 1], points->m[0][(index + step) % (step * (step - 1))], points->m[1][(index + step) % (step * (step - 1))],  points->m[2][(index + step) % (step * (step - 1))]);
        add_polygon( polygons, points->m[0][index + 1], points->m[1][index + 1], points->m[2][index + 1], points->m[0][(index + step + 1) % (step * (step - 1))], points->m[1][(index + step + 1) % (step * (step - 1))], points->m[2][(index + step + 1) % (step * (step - 1))], points->m[0][(index + step) % (step * (step - 1))], points->m[1][(index + step) % (step * (step - 1))], points->m[2][(index + step) % (step * (step - 1))]);
      }
    }
  }
  free_matrix(points);
...
void add_torus( struct matrix * polygons,
  ...
  for ( lat = latStart; lat < latStop; lat++ ) {
    for ( longt = longStart; longt < longStop; longt++ ) {
      ...
      //case 0: edge of the torus
      if (index % step == step - 1) {
        add_polygon( polygons, points->m[0][index], points->m[1][index], points->m[2][index], points->m[0][(index + step) % (step * step)], points->m[1][(index + step) % (step * step)], points->m[2][(index + step) % (step * step)], points->m[0][(index - longt + step) % (step * step)], points->m[1][(index - longt + step) % (step * step)], points->m[2][(index - longt + step) % (step * step)]);
        add_polygon( polygons, points->m[0][index], points->m[1][index], points->m[2][index], points->m[0][(index - longt + step) % (step * step)], points->m[1][(index - longt + step) % (step * step)], points->m[2][(index - longt + step) % (step * step)], points->m[0][index - longt], points->m[1][index - longt], points->m[2][index - longt]);
      }
      
      //case 1: middle of the torus
      else {
        add_polygon( polygons, points->m[0][index], points->m[1][index], points->m[2][index], points->m[0][(index + step) % (step * step)], points->m[1][(index + step) % (step * step)], points->m[2][(index + step) % (step * step)], points->m[0][(index + step + 1) % (step * step)], points->m[1][(index + step + 1) % (step * step)], points->m[2][(index + step + 1) % (step * step)]);
        add_polygon( polygons, points->m[0][index], points->m[1][index], points->m[2][index], points->m[0][(index + step + 1) % (step * step)], points->m[1][(index + step + 1) % (step * step)], points->m[2][(index + step + 1) % (step * step)], points->m[0][index + 1], points->m[1][index + 1], points->m[2][index + 1]);
      }
    }
  }
  free_matrix(points);
